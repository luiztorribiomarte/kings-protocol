...
function openVisionCardModal(index) {
    ...
    modalContent.innerHTML = `
        ...
        <div style="display: flex; gap: 15px; justify-content: flex-end;">
            ...
            <button onclick="saveVisionCard(${index})" style="background: linear-gradient(135deg, #ffffff, #9CA3AF); color: white; border: none; padding: 12px 24px; border-radius: 50px; font-size: 14px; font-weight: 700; cursor: pointer; box-shadow: 0 4px 20px rgba(139, 92, 246, 0.4);">Save Vision</button>
        </div>
    `;
}

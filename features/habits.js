...
function updateMilestones(streak) {
    ...
    if (milestones.length >= 3) {
        ...
        if (streak >= 7) {
            ...
            milestones[0].querySelector('div:last-child').innerHTML = '<div style="font-size: 10px; margin-top: 5px; color: #10B981;">✓ UNLOCKED</div>';
        } else {
        ...
        if (streak >= 15) {
            ...
            milestones[1].querySelector('div:last-child').innerHTML = '<div style="font-size: 10px; margin-top: 5px; color: #10B981;">✓ UNLOCKED</div>';
        } else {
        ...
        if (streak >= 30) {
            ...
            milestones[2].querySelector('div:last-child').innerHTML = '<div style="font-size: 10px; margin-top: 5px; color: #10B981;">✓ UNLOCKED</div>';
        } else {

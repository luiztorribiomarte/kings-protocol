...
(function () {
  ...
  // - Finds the correct tab by:
  //   1) data-page="dashboard" style
  //   2) onclick="showPage('dashboard')" in markup
  //   3) href="#dashboard" or href="...dashboard..."
  // =====================================================
  function findTabForPage(page) {
    ...
    // 4) fallback: old mapping (best effort)
    const map = {
      dashboard: 1,
      goalsHabits: 2,
      workout: 3,
  ...
  function showPage(page) {
    ...
    // ✅ Fire feature hooks (habits.js/mood.js registered here)
    try {
